  ...
  try {
    ...
    if (!accessInfo || !accessInfo.hasAccess) {
      return NextResponse.json(
        { error: 'Подорож не знайдена або немає доступу' },
        { status: 404 }
      )
    }
    ...
    return NextResponse.json(
      { error: 'Помилка отримання подорожі' },
      { status: 500 }
    )
  }
}
...
export async function PUT(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    if (!accessInfo || !accessInfo.isOwner) {
      return NextResponse.json(
        { error: 'Немає прав для редагування цієї подорожі' },
        { status: 403 }
      )
    }
    ...
    return NextResponse.json({
      message: 'Подорож оновлена успішно',
      trip: {
        ...updatedTrip,
        userRole: 'OWNER'
      }
    ...
    return NextResponse.json(
      { error: 'Помилка оновлення подорожі' },
      { status: 500 }
    )
  }
}
...
export async function DELETE(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    if (!accessInfo || !accessInfo.isOwner) {
      return NextResponse.json(
        { error: 'Немає прав для видалення цієї подорожі' },
        { status: 403 }
      )
    }
    ...
    return NextResponse.json({
      message: 'Подорож видалена успішно'
    })
  } catch (error) {
    ...
    return NextResponse.json(
      { error: 'Помилка видалення подорожі' },
      { status: 500 }
    )
  }
}
